  ...
  var WebRTC = function () {
    ...
    _createClass(WebRTC, [{
      ...
      value: function signalJoin(senderId) {
        ...
        if (!existing) {
          var newMember = { id: senderId, connection: null };
          this.members.push(newMember);
          this.addPeerConnection(senderId);
          newMember.connection.createOffer(function (sessionDescription) {
            _this2.signal('offer', {
              target: senderId,
      ...
      value: function signalOffer(senderId, offer) {
        ...
        var member = { id: senderId, connection: null };
      ...
      value: function addPeerConnection(id) {
        ...
        if (member) {
          ...
          pc.onaddstream = function (event) {
            ...
            _this4.trigger(WebRTC.EVENT_CONNECTED);
          };
